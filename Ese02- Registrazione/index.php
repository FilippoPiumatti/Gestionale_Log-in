...
<body>
    ...
    <section id="formReg" class="container">
       ...
       <!--<form class="frmReg">-->
       <form action="datiComuni.php" method="get"><!-- FORM DA RICHIAMARE QUANDO USO UN UNICA POAGINA PER IL RESOCONT
       DEI RISULTATI -->
            ...
            <select class="form-select form-select-lg" name="cboResidenza" id="cmbResidenza">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <input type="button" value="Invia dati with jquery" id="btnJq" class="btn btn-success btn-lg" style="width: 100%">
                    <!--<br><input type="submit" formaction="registrazione.php" formmethod="get" value="Invia"/>-->
                </div>
                <div class="col-sm-4">
    ...
    <section id="formReg" class="container">
        <form action="datiComuni.php" method="post">  form eseguito direttamente con datiAssicurazioe.php-->
     <!-- form eseguito da jquery-->
